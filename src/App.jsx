  ...
  return (
    <>
      <Routes>
        ...
        <Route path='/mypointtotal' element={<MyPoint/>}/>
        <Route path='/mypointplus' element={<MyPoint/>}/>
        <Route path='/mypointminus' element={<MyPoint/>}/>
        <Route path='/mypage' element={<MyPage/>}/>
        <Route path='/myprofile' element={<MyProfile/>}/>
        <Route path='/myprofilefix' element={<MyProfileFix/>}/>
        <Route path='/myout' element={<MyOut/>}/>
      </Routes>
      <SideBar/>
    </>
  );
