...
export default function SurveyContent() {
    ...
    const [ismessage, setIsMessage] = useState("판매 데이터 업로드 (CSV, XLSX 만 가능)");
    ...
    return(
        <div>
            <C.TitleWrapper>
                ...
                <NextBtn onClick={()=>navigate("/")}>다음</NextBtn>
            </C.TitleWrapper>
            ...
            '></Content>
            <UploadBtn onClick={handleClick} className={!upload ? "" : "finish"}>
