    ...
    <>
      ...
      <Profile>
        ...
        <ProfileWrite>
          ...
          <div>
            보유 포인트: <Point>{point}POINT</Point>
          </div>
        </ProfileWrite>
      </Profile>
      <ButtonWrapper>
        <Btn onClick={profileFix}>
          <BtnText>프로필 변경</BtnText>
        </Btn>
        <Btn onClick={pointList}>
          <BtnText>포인트 내역</BtnText>
        </Btn>
      </ButtonWrapper>
      <Hr></Hr>
      <MenuWrapper>
        <Link to='/mylist4'>
          <MenuBox>
            <MenuText>내가 등록한 설문조사</MenuText>
            <img src={next_icon}></img>
          </MenuBox>
        </Link>
        <Link to='/mylist1'>
          <MenuBox>
            <MenuText>내가 응답한 설문조사</MenuText>
            <img src={next_icon}></img>
          </MenuBox>
        </Link>
        <Link to='/mylist2'>
          <MenuBox>
            <MenuText>내가 판매 등록한 설문데이터</MenuText>
            <img src={next_icon}></img>
          </MenuBox>
        </Link>
        <Link to='/mylist3'>
          <MenuBox>
            <MenuText>내가 구매한 설문데이터</MenuText>
            <img src={next_icon}></img>
          </MenuBox>
        </Link>
        <MenuBox>
